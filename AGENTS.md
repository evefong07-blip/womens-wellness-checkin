# womens-wellness-checkin

A lean wellness check-in form for women 40+ in Singapore that captures their main health concerns and delivers a gentle personalised summary with a WhatsApp button to book a free Body Clarity Session with Evelyn.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "238496900+evefong07-blip@users.noreply.github.com"
  git config user.name "evefong07-blip"
  ```
